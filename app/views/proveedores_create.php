...
<div class="container py-3">
  <h1 class="h4 mb-3">Nuevo Proveedor</h1>

  <form method="post" action="<?= u($__base,'index.php?r=proveedores/store') ?>" class="row g-3" novalidate>
    ...
    <div class="col-12">
      ...
      <a class="btn btn-outline-secondary" href="<?= u($__base,'index.php?r=proveedores/index') ?>">Cancelar</a>
    </div>
  </form>
</div>
