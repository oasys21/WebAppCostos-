...
<div class="container py-3">
  <h1 class="h5 mb-3">Editar Cliente</h1>

  <form method="post" action="<?= u($__base,'index.php?r=clientes/update/'.(int)$row['id']) ?>" class="row g-3" novalidate>
    ...
    <div class="col-12">
      ...
      <a class="btn btn-outline-secondary" href="<?= u($__base,'index.php?r=clientes/index') ?>">Volver</a>
    </div>
  </form>
</div>
